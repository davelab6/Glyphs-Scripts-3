...
def syncToControl(aName, cName, dName, bName, NLIName):	
	currentGlyph = Glyphs.font.selectedLayers[0].parent
...
syncToControl("Regular", "C1", "D1", "B", "B NLI")
syncToControl("Regular Oblique", "E1", "F1", "G", "G NLI")
syncToControl("Bold", "H1", "I1", "J", "J NLI")
syncToControl("Bold Oblique", "K1", "L1", "M", "M NLI")